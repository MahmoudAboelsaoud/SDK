...
#define RW 1   //PA1
#define E  2   //PA2
#define LCD_CNTR_PORT_DIR     *(volatile unsigned char*)0x3a   //DDRA
#define LCD_CNTR_PORT_PORT    *(volatile unsigned char*)0x3b   // PORTA
#define LCD_DATA_PORT_DIR     *(volatile unsigned char*)0x37   // DDRB   
#define LCD_DATA_PORT_PORT    *(volatile unsigned char*)0x38    //PORTB  
