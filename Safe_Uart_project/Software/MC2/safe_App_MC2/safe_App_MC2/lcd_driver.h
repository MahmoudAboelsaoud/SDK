...
#define RW 1   //PD1
#define E  2   //PD2
#define LCD_CNTR_PORT_DIR     *(volatile unsigned char*)0x37 //DDIRD
#define LCD_CNTR_PORT_PORT    *(volatile unsigned char*)0x38 // PORTD
...
bool_t Lcd_Display_Int(u16 ch);
bool_t Lcd_Display_String(const u8* str);
bool_t Lcd_Off();
bool_t Lcd_Clean();
bool_t LCD_goToRowColumn(u8 row, u8 col);
